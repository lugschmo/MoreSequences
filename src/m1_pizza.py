...
def run_test_generate_points_on_circle():
    ...
    # Test 2:
    expected = [rg.Point(110.0, 100.0),  # All numbers are approximate.
                rg.Point(100.0, 110.0),
                rg.Point(90.0, 100.0),
                rg.Point(100.0, 90.0),]
    circle = rg.Circle(rg.Point(100, 100), 10)
...
def run_test_draw_points_on_circle():
    ...
    # Test 4:
    title = 'DRAW_POINTS_ON_CIRCLE, test 4:  60 lightblue dots on navy circle.'
    window = rg.RoseWindow(415, 415, title)
    circle = rg.Circle(rg.Point(200, 200), 170)
    circle.fill_color = 'navy'
    draw_points_on_circle(window, circle, 60, 'lightblue')
    window.close_on_mouse_click()
...
def draw_points_on_circle(window, circle, number_of_points, color):
    ...
    for k in range(len(points)):
        center = points[k]
        small_circle = rg.Circle(center, 10)
...
def run_test_pizza():
    ...
    # Test 4:
    title = 'PIZZA test 4:  500 slices, thin (thickness=1) gray lines.'
    window = rg.RoseWindow(400, 400, title)
    circle = rg.Circle(rg.Point(200, 200), 160)
    circle.outline_thickness = 1
    circle.fill_color = 'orange'
    pizza(window, circle, 500, 'gray', 1)
    window.close_on_mouse_click()
...
def run_test_polygon():
    ...
    title = 'POLYGON test 3:  7 segments with gray lines'
    window = rg.RoseWindow(500, 500, title)

    circle = rg.Circle(rg.Point(250, 250), 175)
    circle.outline_thickness = 2
    circle.fill_color = 'skyblue'
    polygon(window, circle, 7, 'gray', 8)
    window.close_on_mouse_click()
...
def run_test_fancy_polygon():
    ...
    title = 'FANCY POLYGON test 4:  51 magenta lines on black circle, hops = 25.'
    window = rg.RoseWindow(480, 350, title)

    circle = rg.Circle(rg.Point(240, 165), 150)
    circle.fill_color = 'black'
    fancy_polygon(window, circle, 51, 25, 'magenta', 1)
    window.close_on_mouse_click()
